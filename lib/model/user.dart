...
class User {
  String alamatPetugas, alamatPosyandu, email, fotoPetugas, namaPetugas, namaPosyandu, nomorPetugas, password;
  String? referenceId;

  User({this.referenceId, required this.alamatPetugas, required this.alamatPosyandu, required this.email, required this.fotoPetugas, required this.namaPetugas, required this.namaPosyandu, required this.nomorPetugas, required this.password});
