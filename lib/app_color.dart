...
class AppColor {
  ...
  static Color yellow = Color(0xFFFFC16E);
  static Color red = Color(0xFFFC3030);
  static Color green = Color(0xFF0CBF1E);
  static Color greenSecondary = Color(0xFF048011);

  static Color darkGrey = Color(0xFF708599);
